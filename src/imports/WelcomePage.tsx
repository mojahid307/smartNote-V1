import svgPaths from "./svg-ynvwq4g7sn";
...
function Frame() {
  return (
    <div className="absolute backdrop-blur-[10px] backdrop-filter bg-[rgba(110,110,33,0.1)] box-border content-stretch flex gap-[10px] items-center justify-center left-1/2 p-[25px] rounded-[44px] size-[82px] top-[533px] translate-x-[-50%]">
      <IcBaselinePlus />
    </div>
  );
}
...
export default function WelcomePage() {
  return (
    <div className="bg-[#ffff45] overflow-clip relative rounded-[40px] size-full" data-name="Welcome Page">
      ...
      <p className="absolute font-['SF_Pro:Bold',sans-serif] font-bold leading-[59px] left-[calc(50%-133px)] text-[43px] text-black text-nowrap top-[195px] tracking-[0.6594px] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        SmartKeeper
      </p>
      <p className="absolute font-['SF_Pro:Bold',sans-serif] font-bold leading-[28px] left-[calc(50%-138px)] text-[22px] text-black text-nowrap top-[254px] tracking-[-0.26px] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        Handel Your Notes Smartly
      </p>
      <ArcticonsNotes />
      <SolarNotesLineDuotone />
      <Frame />
      <p className="absolute font-['SF_Pro:Regular',sans-serif] font-normal leading-[25px] left-[calc(50%-56px)] text-[20px] text-black text-nowrap top-[751px] tracking-[-0.45px] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        Start Writing
      </p>
